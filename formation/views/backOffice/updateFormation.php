...
if (isset($_POST['id'])) {
    $formation = $formationC->showFormation($_POST['id']);
}
...
if (
    ...
    if (
        !empty($_POST['id']) && !empty($_POST['nom']) && !empty($_POST['date_formation']) &&
        !empty($_POST['niveau']) && !empty($_POST['places_max']) && !empty($_POST['prix'])
    ) {
        $formationObj = new Formation(
            ...
            $formation['places_prises'] ?? 0,
            (float)$_POST['prix'],
            $_POST['description'] ?? '',
            $_POST['statut'] ?? 'Active'
        );
        $formationC->updateFormation($formationObj, $_POST['id']);
...
<body>
                    ...
                    <div class="col-lg-8 col-md-10 mx-auto">
                        <div class="card-style">
                            ...
                            <form action="" method="POST" class="form-style" id="formationForm">
                                <input type="hidden" name="id" value="<?php echo $_POST['id'] ?? ($formation['id'] ?? ''); ?>">

                                <div class="form-group">
                                    <label for="nom">Nom de la formation *</label>
                                    <input type="text" class="form-control" id="nom" name="nom" value="<?php echo htmlspecialchars($formation['nom'] ?? ''); ?>">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="date_formation" name="date_formation" value="<?php echo $formation['date_formation'] ?? ''; ?>">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="niveau" name="niveau">
                                            <option value="Débutant" <?php echo (isset($formation['niveau']) && $formation['niveau'] == 'Débutant') ? 'selected' : ''; ?>>Débutant</option>
                                            <option value="Moyen" <?php echo (isset($formation['niveau']) && $formation['niveau'] == 'Moyen') ? 'selected' : ''; ?>>Moyen</option>
                                            <option value="Expert" <?php echo (isset($formation['niveau']) && $formation['niveau'] == 'Expert') ? 'selected' : ''; ?>>Expert</option>
                                        </select>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="places_max" name="places_max" min="1" value="<?php echo $formation['places_max'] ?? ''; ?>">
                                        <small>Places actuellement prises: <?php echo $formation['places_prises'] ?? 0; ?></small>
                                        <small class="error-message" id="places_max-error"></small>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="prix">Prix (TND) *</label>
                                        <input type="number" step="0.01" class="form-control" id="prix" name="prix" min="0" value="<?php echo $formation['prix'] ?? ''; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4"><?php echo htmlspecialchars($formation['description'] ?? ''); ?></textarea>
                                    <div class="char-count" id="description-count"><?php echo strlen($formation['description'] ?? ''); ?>/500 caractères</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="statut" name="statut">
                                        <option value="Active" <?php echo (isset($formation['statut']) && $formation['statut'] == 'Active') ? 'selected' : ''; ?>>Active</option>
                                        <option value="Complète" <?php echo (isset($formation['statut']) && $formation['statut'] == 'Complète') ? 'selected' : ''; ?>>Complète</option>
                                        <option value="Annulée" <?php echo (isset($formation['statut']) && $formation['statut'] == 'Annulée') ? 'selected' : ''; ?>>Annulée</option>
                                    </select>
                                    <small class="error-message" id="statut-error"></small>
                                </div>
    ...
    <script>
        ...
        // CONTROLES DE SAISIE POUR LE FORMULAIRE DE MODIFICATION DE FORMATION (UNIQUEMENT JAVASCRIPT)
            ...
            if (form) {
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    if (!statutSelect.value) {
                        ...
                        statutSelect.classList.add('error-border');
                    }
